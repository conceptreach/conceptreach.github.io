	...
	jQuery('.btn_load_more').click(function(){
		...
		if (now_load > 0) {
			if (addon_options.type == 0) {
				...
				for (i = i_start-1; i < i_start+now_load-1; i++) {
					loaded_object = loaded_object + '<div data-category="'+ addon_options.items[i].sortcategory +'" class="'+ addon_options.items[i].sortcategory +' element col-md-3"><div class="img_block hover_img"><img src="'+ addon_options.items[i].src +'" alt="" /><a href="'+ addon_options.items[i].url +'" class="zoom">Zoom</a></div></div>';
